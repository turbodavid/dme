...
class AccountVoucherFix(models.TransientModel):
    """Fix Wrong reconcilied vouchers"""

    _name = "account.voucher.fix"
    _description = __doc__

    @api.multi
    def account_voucher_fix(self):
