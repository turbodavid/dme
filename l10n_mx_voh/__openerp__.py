...
{
    "name": "Plantilla Plan Contable -VOH-",
    "version": "1.0",
    "author": "DME Soluciones",
	"website" : "http://www.dmesoluciones.com/",
    "category": "Localization/Account Charts",
    "description": """
Template account chart for VOH

This Chart of account is a template for VOH company.
...
This modules and its content will update frequently
    ...
    "demo_xml": [],
    "data": [
        "data/account_template_voh.xml",
        "data/account_tax_voh.xml",
    ],
    "active": False,
    "installable": True,
    "certificate": False,
