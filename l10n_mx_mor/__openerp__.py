...
{
    "name": "Plantilla Plan Contable -MOR-",
    "version": "1.0",
    "author": "DME Soluciones",
	"website" : "http://www.dmesoluciones.com/",
    "category": "Localization/Account Charts",
    "description": """
Template account chart for MOR

This Chart of account is a template for MOR company.
...
This modules and its content will update frequently
    ...
    "demo_xml": [],
    "data": [
        "data/account_template_mor.xml",
        "data/account_tax_mor.xml",
    ],
    "active": False,
    "installable": True,
    "certificate": False,
