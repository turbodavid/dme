...
{
    "name": "Plantilla Plan Contable -ONE-",
    "version": "1.0",
    "author": "DME Soluciones",
    "website" : "http://www.dmesoluciones.com/",
    "category": "Localization/Account Charts",
    "description": """
Template account chart for ONE

This Chart of account is a template for ONE company.
...
This modules and its content will update frequently
    ...
    "demo_xml": [],
    "data": [
	"data/account_type_one.xml",
        "data/account_template_one.xml",
        "data/account_tax_one.xml",
    ],
    "active": False,
    "installable": True,
    "certificate": False,
