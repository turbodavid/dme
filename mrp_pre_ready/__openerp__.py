...
##############################################################################
{
    ...
    This module change workflow, add new state 'pre_ready' after of 'draft', and 'pre_ready' take the workflow of 'draft'

    """,
    'depends': ['mrp', 'stock'],
    'demo': [],
    'data': ['views/mrp_view.xml','data/mrp_workflow.xml'],
    'active': False,
    'installable': True,
}
