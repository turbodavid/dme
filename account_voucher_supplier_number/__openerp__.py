...
{
    "name" : "Account Voucher Supplier Number",
    "version" : "1.0",
    "author" : "DME Soluciones",
    "category" : "account_voucher",
    "description" : """This module change position of the field 'number'.""",
    "website" : "http://www.dmesoluciones.com/",
    "license" : "AGPL-3",
    "depends" : ["account_voucher"],
    "init_xml" : [],
    "demo_xml" : [],
    "update_xml" : ["views/account_voucher_form.xml"],
    "test": [],
    "installable" : True,
    "active" : False,
}
